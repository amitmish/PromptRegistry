      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl bg-white rounded-3xl shadow-2xl z-[101] overflow-hidden border border-slate-200"
          >
            {/* Header / Accent */}
            ...
            <div className="p-8 md:p-12">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-slate-800 leading-none mb-1">Welcome to Prompt Registry</h2>
                  <p className="text-slate-500 font-medium font-mono text-xs uppercase tracking-widest">v1.0 Architecture</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <div className="p-5 bg-slate-50 rounded-2xl border border-slate-100">
                  <div className="mb-3 p-2 bg-white rounded-xl w-fit shadow-sm border border-slate-200">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-slate-100">
                <div className="flex items-center gap-2 text-slate-400">
                  ...
                  <span className="text-xs font-medium">Enterprise Grade Infrastructure</span>
                </div>
                
                <button
                  onClick={onClose}
                  className="w-full sm:w-auto px-8 py-3 bg-slate-900 text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-slate-800 transition-all group"
                >
                  Start Engineering
